...
void MainWindow::init_ui()
{
    ...
    QWidget *play_widget = new QWidget(ui->centralwidget);
    QVBoxLayout *play_layout = new QVBoxLayout(play_widget);
    play_layout->setContentsMargins(0, 0, 0, 0);
    play_layout->setSpacing(8);

    init_video_grid(play_widget);

    QWidget *control_widget = new QWidget(play_widget);
    QVBoxLayout *control_layout = new QVBoxLayout(control_widget);
    control_layout->setContentsMargins(0, 0, 0, 0);
    control_layout->setSpacing(6);

    _progress_slider = new QSlider(Qt::Horizontal, control_widget);
    ...
    play_layout->addWidget(control_widget);

    QWidget *playlist_panel = new QWidget(ui->centralwidget);
    playlist_panel->setMinimumWidth(260);
    playlist_panel->setMaximumWidth(360);
    QVBoxLayout *playlist_layout = new QVBoxLayout(playlist_panel);
    playlist_layout->setContentsMargins(0, 0, 0, 0);
    playlist_layout->setSpacing(6);

    QLabel *playlist_title = new QLabel("Playlist", playlist_panel);
    _playlist_widget = new QListWidget(playlist_panel);
    ...
    _add_button = new QPushButton("Add", playlist_panel);
    _remove_button = new QPushButton("Remove", playlist_panel);
    ...
    main_layout->addWidget(play_widget, 1);
